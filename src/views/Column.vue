<template>
	...
	<div class="header">
		<div class="header-content">
				<svg viewBox="0 0 200 91" class="Icon ZhihuLogo ZhihuLogo--blue Icon--logo" width="64" height="30" aria-hidden="true" style="height: 30px; width: 64px; fill: #0084ff;"><title></title>
...
<script>
	export default{
		...
		created() {
			this.axios.get('http://localhost:8080/api/column/all').then(res =>{
				console.log(res);
