	...
	<div class="login-bar tx-center">
	    ...
	    <div class="login-box">
	    	...
	    	<div class="tab-box" v-if="show && selected === 0">
	    		<div class="sign-account">
					<div class="sign-country">
						<div class="Popover">
							<button role="combobox" aria-expanded="false" id="Popover18-toggle" aria-haspopup="true" aria-owns="Popover18-content" type="button" class="InputButton">中国 +86<svg class="Zi--Select" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M12 16.183l2.716-2.966a.757.757 0 0 1 1.064.001.738.738 0 0 1 0 1.052l-3.247 3.512a.758.758 0 0 1-1.064 0L8.22 14.27a.738.738 0 0 1 0-1.052.758.758 0 0 1 1.063 0L12 16.183zm0-9.365L9.284 9.782a.758.758 0 0 1-1.064 0 .738.738 0 0 1 0-1.052l3.248-3.512a.758.758 0 0 1 1.065 0L15.78 8.73a.738.738 0 0 1 0 1.052.757.757 0 0 1-1.063.001L12 6.818z" fill-rule="evenodd"></path></svg></button>
						</div>
					</div>
				...
				<div class="sign-password">
					<div class="Input-password">
						<label class="Input-wrapper"><input name="username" type="tel" class="Input" placeholder="请输入密码" value=""></label>
					</div>
				...
				<div class="SignContainer-tip"><div><div>未注册手机验证后自动登录</div><div>注册即代表同意<a href="https://www.zhihu.com/terms">《知乎协议》</a><a href="https://www.zhihu.com/term/privacy">《隐私保护指引》</a></div></div><a href="https://www.zhihu.com/org/signup">注册机构号</a></div>
	    	</div>
	    	...
	    	<div class="tab-box" v-if="show && selected === 1">
				...
				<div class="Login-option">
					    <button type="button">海外手机号登录</button>
